<%-- 
    Document   : zoo
    Created on : Sep 23, 2018, 8:59:46 PM
    Author     : Salehin
--%>
...
<html>
    ...
    <head>
        ...
        <!-- FONT AWESOME -->
        <link rel="stylesheet" href="myCSS/zoo.css">
    ...
    <body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="zoo1.png" alt="First slide">
                    </div>
        ...
        <div class="container zcard-container">
            <div class="card">
                <div class="card-header">
                   <h5 class="card-title">Bangladesh National Zoo</h5>
                </div>
                <div class="card-body">
                    <p class="card-text"> 
                        <%
                            try {
                                ...
                                String userQuery = "select description from zooinfo";
